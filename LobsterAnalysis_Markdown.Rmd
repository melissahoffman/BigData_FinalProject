...
AdultLobster2017_Analysis<-curl(url = "https://github.com/melissahoffman/BigData_FinalProject/blob/master/AdultLobster2017_Analysis.csv")

#read_excel("~/Desktop/BigData_FinalProject/AdultLobster2017_Analysis.xlsx")
